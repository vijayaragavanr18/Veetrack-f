export const mockArticles = [{
  ...
  whatHappened: ['Researchers achieved stable room-temperature qubit coherence in a prototype quantum processor.', 'The prototype leverages a novel diamond crystalline lattice to isolate qubits from thermal vibrations.', 'Venture capital investment in quantum computing startups has increased by 45% this quarter.'],
  whyItMatters: ['Bypasses the absolute-zero refrigeration bottleneck, making commercial quantum computing viable.', 'Could break standard RSA encryption methods in seconds, requiring urgent security transitions.', 'Paves the way for massive breakthroughs in artificial intelligence and molecular simulation.'],
  aiActions: ['Begin auditing existing cryptographic systems for post-quantum vulnerability.', 'Track emerging quantum cryptography standards (e.g., NIST lattice-based options).', 'Evaluate strategic partnerships with quantum computing cloud platforms.'],
  ...
  whatHappened: ['Architects proposed vertical, closed-loop megastructures to house 15,000 residents per building.', 'Energy capture is achieved via solar glass facades and wind turbines in ventilation shafts.', 'Social scientists raised alarms about localized micro-communities and urban alienation.'],
  whyItMatters: ['Presents a viable solution to horizontal urban sprawl and habitat destruction.', 'Proves the concept of completely self-sustaining energy and waste loops on a massive scale.', 'Could reshape modern sociology and define the future of high-density housing design.'],
  aiActions: ['Assess properties in municipal regions transitioning towards vertical high-density zoning.', 'Investigate green building technologies like solar glass and kinetic wind dynamos.', 'Integrate micro-community social considerations into urban project planning.'],
  ...
  whatHappened: ['An unknown runner won the Midnight Ultramarathon with a sub-four-minute mile final stretch.', 'Athletes utilized metabolic tracking patches providing real-time neural network guidance.', 'Sensors showed the runner maintained stable glycogen consumption and minimal fatigue.'],
  whyItMatters: ['Demonstrates the power of combining real-time human bio-telemetry with AI-driven training models.', 'Re-evaluates the absolute physical limits of human endurance and athletic capability.', 'Signals a major shift in how sports training, tracking, and execution are structured.'],
  aiActions: ['Integrate continuous metabolic tracking devices into professional athletic training regimens.', 'Develop software interfaces that provide real-time biomechanical feedback to endurance athletes.', 'Explore broader medical applications of predictive neural networks for glycogen and oxygen regulation.'],
  ...
  whatHappened: ['A new contemporary art exhibition features massive brutalist concrete and steel sculptures.', 'The show intentionally excludes all digital displays, projection mappings, and audio guides.', 'The gallery has recorded record-breaking crowds seeking tactile experiences.'],
  whyItMatters: ['Represents a growing cultural backlash and fatigue toward screen-dominated lives.', 'Re-establishes the importance of physical space and texture in modern art curation.', 'Shows that consumers are willing to disconnect from digital networks for tactile encounters.'],
  aiActions: ['Explore physical design elements to create unique customer touchpoints offline.', 'Design offline interactive experiences that address digital fatigue as a market opportunity.', 'Balance digital marketing campaigns with tactile, high-quality physical collateral.'],
